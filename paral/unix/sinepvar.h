...
extern char WORD[17];
extern char * FORMAT;
extern double * PHASE; // массив фаз начала стимула
...
extern float CA;  //коэффициент усиления сигнала
extern int FIRST_EP,LAST_EP;
extern float MIN_FRQ,MAX_FRQ; // частотный Аиапазон выАеляемого сигнала
